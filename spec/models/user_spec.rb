...
#       user = create_user
#       secret1 = user.secrets.create(conten: 'secret 1')
#       secret2 = user.secrets.create(conten: 'secret 2')
#       expect(user.secrets).to include(secret1)
#       expect(user.secrets).to include(secret2)
#     end
#     it 'has many likes' do
#       user = create_user
#       secret1 = user.secrets.create(conten: 'Oops')
#       secret2 = user.secrets.create(conten: 'I did it again')
